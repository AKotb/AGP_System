...
for year in range(2002, 2018):
	for month in range(1,13):
		...
		s1 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_SOILM_1.tif")
		ref = s1
		s1 = s1.ReadAsArray()
		s2 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_SOILM_2.tif")
		s2 = s2.ReadAsArray()
		s3 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_SOILM_3.tif")
		s3 = s3.ReadAsArray()
		s4 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_SOILM_4.tif")
		s4 = s4.ReadAsArray()
		s5 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_WEASD.tif")
		s5 = s5.ReadAsArray()
		s6 = gdal.Open("GLDAS_NOAH10_M.A"+ monthStr+".001_TCDC.tif")
		s6 = s6.ReadAsArray()
		...
		dst_ds = driver.Create( "month_NOAH_"+str(totMonths)+".tif", shape[1], shape[0], 1, gdal.GDT_Float32)
